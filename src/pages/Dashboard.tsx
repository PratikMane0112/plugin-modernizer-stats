      ...
      series: [
        {
          ...
          data: [
            { value: overview.successfulMigrations, name: 'Success', itemStyle: { color: colors.success.dark } },
            { value: overview.failedMigrations, name: 'Failed', itemStyle: { color: colors.error.dark } },
          ],
        },
      ],
    };
